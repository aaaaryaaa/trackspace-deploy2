  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (checkDomainAccess('AI-ML')) {
        ...
        const res1 = await fetch(
          `${BaseUrl}/api/progress/aimlweek1`,
          {
            method: 'POST',
            body: JSON.stringify({
              _id: formData.phone_number,
        ...
        const res2 = await fetch(
          `${BaseUrl}/api/progress/aimlweek2`,
          {
            method: 'POST',
            body: JSON.stringify({
              _id: formData.phone_number,
        ...
        const res3 = await fetch(
          `${BaseUrl}/api/progress/aimlweek3`,
          {
            method: 'POST',
            body: JSON.stringify({
              _id: formData.phone_number,
        ...
        const res4 = await fetch(
          `${BaseUrl}/api/progress/aimlweek4`,
          {
            method: 'POST',
            body: JSON.stringify({
              _id: formData.phone_number,
      ...
      if (checkDomainAccess('Design')) {
        ...
        const res1 = await fetch(
          `${BaseUrl}/api/progress/designweek1`,
          {
            method: 'POST',
            body: JSON.stringify({
              _id: formData.phone_number,
        ...
        const res2 = await fetch(
          `${BaseUrl}/api/progress/designweek2`,
          {
            method: 'POST',
            body: JSON.stringify({
              _id: formData.phone_number,
        ...
        const res3 = await fetch(
          `${BaseUrl}/api/progress/designweek3`,
          {
            method: 'POST',
            body: JSON.stringify({
              _id: formData.phone_number,
        ...
        const res4 = await fetch(
          `${BaseUrl}/api/progress/designweek4`,
          {
            method: 'POST',
            body: JSON.stringify({
              _id: formData.phone_number,
